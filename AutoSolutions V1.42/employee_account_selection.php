...
<?php
    ...
    $sqlaccountcount = "SELECT COUNT(*) as total FROM account_tbl";
    $sqlaccountcountquery = mysql_query($sqlaccountcount, $connection);
    $count = mysql_fetch_assoc($sqlaccountcountquery);
...
<?php
    ...
    $sqlaccount = "SELECT * FROM account_tbl";
    $sqlaccountquery = mysql_query($sqlaccount, $connection);

    echo "<tr><th style='border:1px solid black'>Customer ID</th><th style='border:1px solid black'>username</th><th style='border:1px solid black'>password</th></tr>";

    while($row = mysql_fetch_assoc($sqlaccountquery, MYSQL_ASSOC)) {
        echo "<tr>";
        echo "<td style='border:1px solid black'>" . $row['cust_id'] . "</td><td style='border:1px solid black'>" . $row['username'] . "</td><td style='border:1px solid black'>" . $row['password'] . "</td>";
        echo "</tr>";
    }
