<?php
    ...
    if(isset($_GET['quantity1'])) {
        ...
        $name = ">Vehicle: 2x Frong Left and Right ABS Wheel Speed Sensor";
        $price = 17.29 * $quantity;

        $file2r = fopen("absitem2.txt", "r");
        $stock = fgets($file2r);
        if($stock == 0) {
            $stock += 100;
        }
