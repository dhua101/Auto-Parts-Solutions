...
<body>
    ...
    <div class="w3-main" style="margin-left:200px; margin-top:200px;">
        <div class="w3-panel">
            <div class="w3-half borderline">
                <div class="w3-center">
                    <h4>Customer Shopping Form</h4>
                </div>
                <form method="GET" action="infocheck.php">
                    First Name:
                    ...
                    Province/State:
                    <input type='text' name='provstate' id='provstate'><br><br>
                    Country:
                    <input type='text' name='country' id='country'><br><br>
                    Postal Code:
                    <input type='text' name='postalzip' id='postalzip'><br><br>
                    Email:
