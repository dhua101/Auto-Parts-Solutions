...
?>
        ...
        <div class="col-xs-12" style="margin-left:140px">
                <div class="w3-panel">
                    <h3>SQL Results</h3>
                    <div id="content">
...
<?php
    ...
    $sqlcustomerinfocount = "SELECT COUNT(*) as total FROM information_tbl";
    $sqlcustomerinfocountquery = mysql_query($sqlcustomerinfocount, $connection);
    $count = mysql_fetch_assoc($sqlcustomerinfocountquery);
...
<?php
    ...
    $sqlcustomerinfo = "SELECT * FROM information_tbl";
    $sqlcustomerinfoquery = mysql_query($sqlcustomerinfo, $connection);

    echo "<tr><th style='border:1px solid black'>Info ID</th><th style='border:1px solid black'>First Name</th><th style='border:1px solid black'>Last Name</th><th style='border:1px solid black'>Address 1</th><th style='border:1px solid black'>Address 2</th><th style='border:1px solid black'>City</th><th style='border:1px solid black'>Province/State</th><th style='border:1px solid black'>Country</th><th style='border:1px solid black'>Postal Zip</th><th style='border:1px solid black'>Email</th><th style='border:1px solid black'>Phone</th><th style='border:1px solid black'>Extra</th><th style='border:1px solid black'>Date Entered</th></tr>";

    while($row = mysql_fetch_assoc($sqlcustomerinfoquery, MYSQL_ASSOC)) {
        echo "<tr>";
        echo "<td style='border:1px solid black'>" . $row['info_id'] . "</td><td style='border:1px solid black'>" . $row['first_name'] . "</td><td style='border:1px solid black'>" . $row['last_name']  . "</td><td style='border:1px solid black'>" . $row['address_first'] . "</td><td style='border:1px solid black'>" . $row['address_second'] . "</td><td style='border:1px solid black'>" . $row['city'] . "</td><td style='border:1px solid black'>" . $row['province'] . "</td><td style='border:1px solid black'>" . $row['country'] . "</td><td style='border:1px solid black'>" . $row['postal_zip'] . "</td><td style='border:1px solid black'>" . $row['email'] . "</td><td style='border:1px solid black'>" . $row['phone'] . "</td><td style='border:1px solid black'>" . $row['extra'] . "</td><td style='border:1px solid black'>" . $row['date_info'] . "</td>";
        echo "</tr>";
    }
