        ...
        <div class="col-xs-6">
                        ...
                        <form method="post" action="employee_sql_statement.php">
                            ...
                            <select name="tables">
                                ...
                                <option name="absstock" value="absstock_tbl">absstock_tbl</option>
                                <option name="bmwstock" value="bmwstock_tbl">bmwstock_tbl</option>
                                <option name="brakestock" value="brakestock_tbl">brakestock_tbl</option>
                                <option name="headlightsstock" value="headlightsstock_tbl">headlightsstock_tbl</option>
                                <option name="hondastock" value="hondastock_tbl">hondastock_tbl</option>
                                <option name="lightsstock" value="lightsstock_tbl">lightsstock_tbl</option>
                                <option name="sumtiresstock" value="sumtiresstock_tbl">sumtiresstock_tbl</option>
                                <option name="taillightsstock" value="taillightsstock_tbl">taillightsstock_tbl</option>
                                <option name="tiresstock" value="tiresstock_tbl">tiresstock_tbl</option>
                                <option name="toyotastock" value="toyotastock_tbl">toyotastock_tbl</option>
                                <option name="wintiresstock" value="wintiresstock_tbl">wintiresstock_tbl</option>
                            </select>
                            <br>
                            Condition:
