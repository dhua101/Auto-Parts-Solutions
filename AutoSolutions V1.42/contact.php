...
<body>
    <div class="w3-top">
        <ul class="w3-navbar w3-white w3-top w3-left-align"style="height:100px">
            ...
            <li class="w3-hide-small w3-right" style="margin-top:40px; margin-right:100px;"><a href="accountsignin.php">Account Sign In</a></li>
        ...
        <ul class="w3-navbar w3-theme w3-top w3-left-align" style="margin-top:100px;">
            ...
            <li class="w3-hide-small"><a href="learnmore.php" class="w3-hover-white">About Auto Solutions</a></li>
    ...
    <div class="w3-main" style="margin-left:150px; margin-top:175px;">
        <div class="w3-panel">
            <h1>BY EMAIL</h1>
            <p>email us your concern at abc123@autosolution.ca</p>
            <h1>BY PHONE</h1>
            <p>Customer Support: 1-888-849-3246</p>
            <h1>BY MAIL</h1>
            <p>
